import { ArrowPathRoundedSquareIcon, PencilIcon, UserGroupIcon } from "@heroicons/react/24/outline";
  ...
  return ( 
    ...
    <div className="flex items-center bg-white rounded-md shadow-md px-4 py-6">
      ...
      <div className="mx-4">
        ...
        <p className="text-gray-700">All Users</p>
      </div>
    </div>
    <div className="flex items-center bg-white rounded-md shadow-md px-4 py-6">
      <div className="bg-indigo-600 rounded p-3">
      ...
      <div className="mx-4">
        ...
        <p className="text-gray-700">All Blogs</p>
      </div>
    </div>
    <div className="flex items-center bg-white rounded-md shadow-md px-4 py-6">
      <div className="bg-indigo-600 rounded p-3">
      ...
      <div className="mx-4">
        ...
        <p className="text-gray-700">All Transactions</p>
      </div>
    </div>
  </div>
   );
